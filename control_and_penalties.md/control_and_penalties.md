...
2.1 Если Участник принимает решение сняться с турнира, применяются следующие правила:

- если на групповом этапе Участник сыграл менее половины матчей, он удаляется из таблицы, а все матчи с его участием аннулируются;
- если на групповом этапе Участник сыграл половину матчей или более, его результаты сохраняются, а за несыгранные матчи ему проставляются технические поражения `0:5 ТП`.

При подсчёте количества сыгранных матчей учитываются только матчи, в которых Участник фактически принял участие. Технические поражения в это количество не включаются.
...
2.4 Если Участник, вышедший в стадию плей-офф, в текущем раунде не сыграл ни одного матча, он подлежит дисквалификации в соответствии с п. 2.3.
